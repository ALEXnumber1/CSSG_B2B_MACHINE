...
export const SEQUENCES: Record<string, Sequence> = {
  ...
  consultoria_riesgos_guia: {
    id: 'consultoria_riesgos_guia',
    name: 'Secuencia Consultoría y Análisis de Riesgos (lead magnet guía ISO 31000)',
    emails: [
      { day: 0, templateKey: 'consultoria_riesgos_guia_1', scoreBonus: 0 },
    ],
  },
  corporate_security_en: {
    id: 'corporate_security_en',
    name: 'Corporate Security EN sequence (confidential assessment request)',
    emails: [
      { day: 0, templateKey: 'corporate_security_en_1', scoreBonus: 0 },
    ],
  },
  diplomatic_security_en: {
    id: 'diplomatic_security_en',
    name: 'Diplomatic Security EN sequence (Escudo Diplomático assessment/tender request)',
    emails: [
