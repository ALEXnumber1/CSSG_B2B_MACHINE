...
const EsrmReadinessGracias = lazy(() => import('./pages/EsrmReadinessGracias'))
...
function AppContent() {
  ...
  const isStandaloneLanding = location.pathname === '/consultoria/escudo-diplomatico' || location.pathname.startsWith('/esrm-readiness');
