    ...
    <div style={{ background: NAVY, color: WHITE, fontFamily: "'Inter', sans-serif", lineHeight: 1.6, minHeight: '100vh' }}>
      ...
      <main className="relative flex flex-col items-center justify-center px-6 overflow-hidden" style={{ minHeight: '78vh' }}>
        ...
        <motion.div className="relative max-w-lg w-full text-center py-16" initial="hidden" animate="visible" variants={fadeUp}>
          ...
          <p style={{ color: MUTED }}>
            {state.duplicate
              ? <>We already have your information on file. A senior consultant will follow up with you at <b style={{ color: WHITE }}>{state.correo}</b> shortly.</>
              : <>A senior consultant will review your request and contact you at <b style={{ color: WHITE }}>{state.correo}</b> within 12 business hours to schedule your confidential assessment.</>}
          </p>

          <div className="mt-8 pt-8 text-left" style={{ borderTop: `1px solid ${BORDER}` }}>
            <p className="text-xs font-semibold uppercase mb-4" style={{ color: ICE, letterSpacing: '.14em' }}>In the meantime</p>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <Mail className="w-4 h-4 shrink-0 mt-0.5" style={{ color: GOLD }} />
                <span className="text-sm" style={{ color: MUTED }}>Save <b style={{ color: WHITE }}>gerencia@globalservices-ven.com</b> as a trusted sender so our consultant's email doesn't land in spam.</span>
              </li>
              <li className="flex items-start gap-3">
                <ShieldCheck className="w-4 h-4 shrink-0 mt-0.5" style={{ color: GOLD }} />
                <span className="text-sm" style={{ color: MUTED }}>Already have a contractor in place? Mention it in your first call — we can start with an audit of your current provider instead of proposing a new one.</span>
              </li>
              <li className="flex items-start gap-3">
                <Lock className="w-4 h-4 shrink-0 mt-0.5" style={{ color: GOLD }} />
                <span className="text-sm" style={{ color: MUTED }}>Your information is handled under confidentiality protocol. You may withdraw your request at any time.</span>
              </li>
            </ul>
          </div>
