          ...
          <div className="mt-8 pt-8 text-left" style={{ borderTop: `1px solid ${BORDER}` }}>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-gray-400">Guarda el remitente <b className="text-gray-300">operaciones@cssg-global.com</b> para no perderte el resto de la serie con criterios de contratación.</span>
              </li>
              <li className="flex items-start gap-3">
