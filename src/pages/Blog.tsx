...
export const getBlogPosts = (t: any): BlogEntry[] => [
  {
    ...
    title: t('posts.como-elegir-empresa-seguridad-privada-venezuela.title'),
    excerpt: t('posts.como-elegir-empresa-seguridad-privada-venezuela.excerpt'),
    date: '2026-04-12',
    readTime: '8 min',
    category: t('categories.Guía Práctica'),
  ...
  },
  {
    ...
    title: t('posts.5-errores-seguridad-corporativa.title'),
    excerpt: t('posts.5-errores-seguridad-corporativa.excerpt'),
    date: '2026-04-05',
    readTime: '6 min',
    category: t('categories.Análisis'),
    categoryColor: 'text-orange-400 bg-orange-500/10',
    image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=80',
  },
  {
    slug: 'iso-9001-seguridad-privada-importancia',
    title: t('posts.iso-9001-seguridad-privada-importancia.title'),
    excerpt: t('posts.iso-9001-seguridad-privada-importancia.excerpt'),
    date: '2026-03-28',
    readTime: '5 min',
    category: t('categories.Certificaciones'),
    categoryColor: 'text-[#EAB308] bg-[#EAB308]/10',
    image: 'https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&w=1200&q=80',
  },
  {
    slug: 'seguridad-corporativa-caracas-guia-completa',
    title: t('posts.seguridad-corporativa-caracas-guia-completa.title'),
    excerpt: t('posts.seguridad-corporativa-caracas-guia-completa.excerpt'),
    date: '2026-03-20',
    readTime: '10 min',
    category: t('categories.Guía Completa'),
    categoryColor: 'text-sky-400 bg-sky-500/10',
    image: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=1200&q=80',
  },
  {
    slug: 'analisis-pestel-seguridad-venezuela',
    title: t('posts.analisis-pestel-seguridad-venezuela.title'),
    excerpt: t('posts.analisis-pestel-seguridad-venezuela.excerpt'),
    date: '2026-03-15',
    readTime: '7 min',
    category: t('categories.Metodología'),
  ...
  },
  {
    ...
    title: t('posts.rrhh-socio-critico-seguridad.title'),
    excerpt: t('posts.rrhh-socio-critico-seguridad.excerpt'),
    date: '2026-04-26',
    readTime: '6 min',
    category: t('categories.Análisis'),
  ...
  {
    slug: 'sueldo-minimo-vigilantes-venezuela',
    title: t('posts.sueldo-minimo-vigilantes-venezuela.title'),
    excerpt: t('posts.sueldo-minimo-vigilantes-venezuela.excerpt'),
    date: '2026-05-01',
    readTime: '7 min',
    category: t('categories.Análisis'),
      ...
      try {
        ...
        if (!error && data) {
          const formatted = data.map(p => ({
            ...
            categoryColor: 'text-sky-400 bg-sky-500/10',
            featured: p.featured,
            image: p.image || p.image_url || 'https://images.unsplash.com/photo-1557597774-9d273605dfa9?auto=format&fit=crop&w=1200&q=80'
          }));
      ...
      <div className="container mx-auto px-6 max-w-6xl relative">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded border border-sky-500/20 bg-sky-500/5 mb-8">
            ...
            <span className="text-[10px] font-bold text-sky-300 uppercase tracking-[0.2em]">{t('header_badge')}</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold tracking-tighter text-white mb-4">
            {t('header_title_1')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-white">{t('header_title_2')}</span>
          </h1>
          <p className="text-gray-400 text-lg max-w-2xl">{t('header_desc')}</p>
        </motion.div>
                ...
                <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl overflow-hidden relative hover:border-sky-500/20 transition-all flex flex-col md:flex-row">
                  ...
                  <div className="md:w-1/2 p-8 md:p-12 relative flex flex-col justify-center">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <span className="text-[10px] font-bold text-[#EAB308] uppercase tracking-wider px-2.5 py-1 rounded-full bg-[#EAB308]/10">{t('featured_badge')}</span>
                    </div>
