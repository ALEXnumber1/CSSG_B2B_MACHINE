      ...
      <div className="mt-12 p-8 rounded-3xl border border-sky-500/30 bg-sky-500/5">
        <div className="flex items-start gap-4 mb-4">
          ...
          <div>
            ...
            <h3 className="text-lg font-black text-white">Obtenga su Índice de Seguridad Corporativa Ahora</h3>
            <p className="text-sm text-gray-500 mt-1">Antes del diagnóstico formal, mida su perfil de riesgo en 5 minutos. Scoring FMEA por 4 pilares con informe PDF descargable — la línea base objetiva que su dirección necesita ver.</p>
          </div>
        </div>
