...
function fuente_label(fuente) {
  const map = {
    ...
    lp_empresa_seguridad: 'Auditoría de Empresa de Seguridad',
    lp_consultoria_riesgos: 'Evaluación de Riesgos de Seguridad',
  ...
  <div style="max-width:560px;margin:0 auto;padding:32px 16px;">
    ...
    <p style="color:#333;font-size:11px;text-align:center;margin:0;">Sistema B2B · CSSG · cssg-global.com</p>
      ...
      const welcomeSubjects = {
        ...
        lp_empresa_seguridad: `Su solicitud fue registrada — un consultor le contacta en menos de 12h | CSSG Global`,
        lp_consultoria_riesgos: `Su solicitud fue registrada — un consultor le contacta en menos de 12h | CSSG Global`,
