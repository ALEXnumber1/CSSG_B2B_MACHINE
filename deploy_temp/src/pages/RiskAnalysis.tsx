      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          ...
          >
            ...
            <ChevronDown className={`w-4 h-4 text-gray-500 transition-transform duration-300 ${showMethodology ? 'rotate-180' : ''}`} />
          </button>
        </motion.div>
                      ...
                      >
                        <div className="px-6 pb-6 space-y-2">
                          {pillar.questions.map((q) => {
                            ...
                            const isDetailOpen = expandedDetail === q.id;
                              ...
                              <div key={q.id} className="rounded-xl border border-white/[0.03] bg-white/[0.015]">
                                <div className="flex items-start gap-3 p-4">
                                  ...
                                  <div className="flex-1 min-w-0">
                                    ...
                                    {/* Botón de detalle */}
                                    <button
                                      onClick={() => setExpandedDetail(isDetailOpen ? null : q.id)}
