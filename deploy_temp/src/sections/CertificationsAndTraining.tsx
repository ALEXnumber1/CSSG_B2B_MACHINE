            ...
            <div className="relative z-10 flex flex-col h-full">
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="text-right">
                  <p className="text-[10px] text-sky-500 font-black uppercase tracking-widest">ISO 9001:2015</p>
                  <p className="text-[8px] text-gray-500">Sistema de Gestión de Calidad</p>
                </div>
              </div>

              <h3 className="text-3xl font-bold text-white mb-4">Certificación de Calidad Internacional</h3>
              <p className="text-gray-400 text-sm leading-relaxed mb-8 flex-grow">
                Nuestra certificación <span className="text-sky-400 font-bold">ISO 9001:2015</span> avala internacionalmente la excelencia de nuestros procesos operativos, administrativos y tácticos, garantizando un estándar de seguridad privada de clase mundial.
              </p>
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 bg-black/40 group/cert">
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/60 pointer-events-none">
                  <span className="text-white font-bold text-xs uppercase tracking-widest px-4 py-2 border border-white/20 rounded-full">Ver Documento Oficial</span>
                </div>
              </div>
            </div>
          </motion.div>
              ...
              <div className="flex items-start justify-between mb-8">
                ...
                <div className="text-right">
                  <div className="inline-flex items-center gap-2 px-2 py-1 rounded bg-emerald-500/10 border border-emerald-500/20 mb-2">
                    ...
                    <span className="text-[9px] font-bold text-emerald-400 uppercase tracking-widest">Protocolo de Verificación</span>
                  </div>
                  <p className="text-[8px] text-gray-500 leading-tight">Lista de Asistencia · Foto In Situ · Hash SHA-256</p>
                </div>
              </div>

              <div className="mb-8">
                <h3 className="text-2xl md:text-4xl font-bold text-white mb-2 leading-tight">
                  Academia de Formación <br/>
                ...
                <p className="text-emerald-400/80 text-[10px] md:text-xs font-bold uppercase tracking-[0.1em]">
                  E-learning especializado en capacitaciones de tecnología y seguridad
                </p>
              </div>
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <h4 className="text-white text-sm font-bold tracking-tight">{t(`shield.c${item.id}_title`)}</h4>
                    </div>
                    <p className="text-[11px] text-gray-500 leading-relaxed pl-1">
                      {t(`shield.c${item.id}_desc`)}
                    </p>
                  </motion.div>
                ))}
              </div>
