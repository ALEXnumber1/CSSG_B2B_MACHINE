    ...
    <section className="py-24 relative overflow-hidden bg-[#030305]">
      <div className="container mx-auto px-6">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="relative rounded-[4rem] overflow-hidden border border-white/10 bg-[#0D0F16] shadow-2xl"
        >
          <div className="flex flex-col lg:flex-row items-stretch">
            {/* Left side: Large Image */}
            <div className="lg:w-1/2 relative min-h-[400px] lg:min-h-[600px]">
              <img 
                src="/strategic_security.png" 
                alt="Custodia y Vigilancia de Alta Criticidad" 
              ...
              {/* Overlay Badge */}
              <div className="absolute top-8 left-8 p-6 bg-orange-600/90 backdrop-blur-md rounded-2xl border border-white/20 shadow-xl">
                <div className="text-3xl font-black text-white leading-none">17+</div>
                <div className="text-[10px] font-bold text-orange-100 uppercase tracking-widest mt-1">Años de Excelencia</div>
              </div>
            </div>
            ...
            <div className="lg:w-1/2 p-10 md:p-16 lg:p-20 flex flex-col justify-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-400 text-[10px] font-black uppercase tracking-[0.3em] mb-8">
                ...
                <span>NUESTRO PRINCIPAL SERVICIO</span>
              </div>

              <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tighter leading-[0.95]">
                Custodia y Vigilancia para <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-white">
                  Entes de Alta Criticidad
                </span>
              </h2>

              <p className="text-gray-400 text-lg leading-relaxed mb-10 font-light">
                Nuestro servicio está fundamentado en el <span className="text-white font-bold">cumplimiento estricto de procesos preestablecidos y probados</span> en escenarios de alta complejidad. 
                Garantizamos una calidad superior mediante un seguimiento riguroso bajo el estándar <span className="text-sky-400 font-bold italic">ISO 9001</span>.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
                {[
                  'Metodología Accountability',
                  'Certificación ISO 9001:2015',
                  'Procesos 100% Auditables',
                  'Calidad de Servicio de Élite'
                ].map((item, i) => (
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6">
                ...
                >
                  ...
                  <span className="uppercase tracking-widest text-sm">Agendar Estudio Previo</span>
                ...
                <div className="flex items-center gap-4 text-gray-500">
                  ...
                  <div className="text-[10px] font-bold uppercase tracking-widest leading-tight">
                    Seguridad Basada <br /> En Objetivos
                  </div>
                </div>
              </div>
            </div>
